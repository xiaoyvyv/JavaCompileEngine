...
public interface Types {
   ...
   * @return {@code true} if and only if the first signature is a subsignature of the second
   ...
   * @throws IllegalArgumentException if the given type has no unboxing conversion
   ...
   * @throws IllegalArgumentException if the component type is not valid for an array
   */
   ...
   * @return the type corresponding to the type element and actual type arguments
   * @throws IllegalArgumentException if too many or too few type arguments are given, or if an
   ...
   * @param typeElem the type element
   * @param typeArgs the actual type arguments
   * @return the type corresponding to the type element and actual type arguments, contained within
   * the given type
   * @throws IllegalArgumentException if too many or too few type arguments are given, or if an
   * inappropriate type argument, type element, or containing type is provided
   */
