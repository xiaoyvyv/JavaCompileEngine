...
public interface TypeParameterElement extends Element {
   ...
   *
   * @return the generic class, interface, method, or constructor that is parameterized by this type
   * parameter
   */
  ...
  /**
   * Returns the {@linkplain TypeParameterElement#getGenericElement generic element} of this type
   * parameter.
   *
