 ...
 *
 * @implNote Also as of {@link javax.lang.model.SourceVersion#RELEASE_8 RELEASE_8}, in the reference
 * implementation an {@code IntersectionType} is used to model the explicit target type of a cast
 * expression.
 * @since 1.8
 */
