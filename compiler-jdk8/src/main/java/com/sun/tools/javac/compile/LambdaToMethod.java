...
import static com.sun.tools.javac.compile.LambdaToMethod.LambdaSymbolKind.CAPTURED_THIS;
import static com.sun.tools.javac.compile.LambdaToMethod.LambdaSymbolKind.CAPTURED_VAR;
import static com.sun.tools.javac.compile.LambdaToMethod.LambdaSymbolKind.LOCAL_VAR;
import static com.sun.tools.javac.compile.LambdaToMethod.LambdaSymbolKind.PARAM;
import static com.sun.tools.javac.compile.LambdaToMethod.LambdaSymbolKind.TYPE_VAR;
...
import com.sun.tools.javac.compile.LambdaToMethod.LambdaAnalyzerPreprocessor.LambdaTranslationContext;
import com.sun.tools.javac.compile.LambdaToMethod.LambdaAnalyzerPreprocessor.ReferenceTranslationContext;
import com.sun.tools.javac.compile.LambdaToMethod.LambdaAnalyzerPreprocessor.TranslationContext;
    ...
    class LambdaAnalyzerPreprocessor extends TreeTranslator {
        ...
        void captureLocalClassDefs(Symbol csym, final LambdaTranslationContext lambdaContext) {
            ...
            if (localCDef != null && lambdaContext.freeVarProcessedLocalClasses.add(csym)) {
                Lower.BasicFreeVarCollector fvc = lower.new BasicFreeVarCollector() {
                    @Override
         ...
         */
        public class ReferenceTranslationContext extends TranslationContext<JCMemberReference> {
