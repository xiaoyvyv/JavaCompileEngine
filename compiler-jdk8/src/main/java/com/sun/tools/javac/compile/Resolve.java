...
import com.sun.tools.javac.compile.Attr.ResultInfo;
import com.sun.tools.javac.compile.DeferredAttr.AttrMode;
import com.sun.tools.javac.compile.DeferredAttr.DeferredAttrContext;
import com.sun.tools.javac.compile.DeferredAttr.DeferredType;
import com.sun.tools.javac.compile.Resolve.MethodResolutionContext.Candidate;
import com.sun.tools.javac.compile.Resolve.MethodResolutionDiagHelper.DiagnosticRewriter;
import com.sun.tools.javac.compile.Resolve.MethodResolutionDiagHelper.Template;
...
import static com.sun.tools.javac.compile.Resolve.MethodResolutionPhase.*;
 ...
 *************************************************************************/
    ...
    abstract class AbstractMethodCheck implements MethodCheck {
        ...
        protected void reportMC(DiagnosticPosition pos, MethodCheckDiag diag, Infer.InferenceContext inferenceContext, Object... args) {
    ...
    MethodCheck resolveMethodCheck = new AbstractMethodCheck() {
        ...
        private void varargsAccessible(final Env<AttrContext> env, final Type t, final Infer.InferenceContext inferenceContext) {
        ...
        private ResultInfo methodCheckResult(final boolean varargsCheck, Type to,
            ...
            Check.CheckContext checkContext = new MethodCheckContext(!deferredAttrContext.phase.isBoxingRequired(), deferredAttrContext, rsWarner) {
 ...
 ****************************************************************************/
    ...
    class MethodResolutionContext {
        ...
        DeferredAttrContext deferredAttrContext(Symbol sym, Infer.InferenceContext inferenceContext, ResultInfo pendingResult, Warner warn) {
