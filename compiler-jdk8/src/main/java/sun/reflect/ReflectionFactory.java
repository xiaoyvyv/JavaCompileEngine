...
public class ReflectionFactory {
    ...
    /**
     * Called only by Modifier's static initializer
     */
     ...
     * the static initializer is run since Method's
     * static initializer (more properly, that for
     * AccessibleObject) causes this class's to be
    ...
    private static LangReflectAccess langReflectAccess() {
        if (langReflectAccess == null) {
            // Call a static method to get class Modifier
