...
public class Reflection {
     ...
     * ignoring frames associated with Method.invoke()
    ...
    public static boolean quickCheckMemberAccess(Class<?> memberClass,
                                                 int modifiers) {
        return java.lang.reflect.Modifier.isPublic(getClassAccessFlags(memberClass) & modifiers);
    }
    ...
    public static boolean verifyMemberAccess(Class<?> currentClass,
        ...
        if (!java.lang.reflect.Modifier.isPublic(getClassAccessFlags(memberClass))) {
        ...
        if (!successSoFar && !java.lang.reflect.Modifier.isPrivate(modifiers)) {
    ...
    public static java.lang.reflect.Field[] filterFields(Class<?> containingClass,
    ...
    public static java.lang.reflect.Method[] filterMethods(Class<?> containingClass, java.lang.reflect.Method[] methods) {
        if (methodFilterMap == null) {
            // Bootstrapping
            return methods;
        }
        return (java.lang.reflect.Method[]) filter(methods, methodFilterMap.get(containingClass));
    }

    private static java.lang.reflect.Member[] filter(java.lang.reflect.Member[] members, String[] filteredNames) {
        ...
        java.lang.reflect.Member[] newMembers =
                (java.lang.reflect.Member[]) java.lang.reflect.Array.newInstance(members[0].getClass(), numNewMembers);
        int destIdx = 0;
        for (java.lang.reflect.Member member : members) {
            boolean shouldSkip = false;
            for (String filteredName : filteredNames) {
