 ...
 * @since 1.5
 */
class AnnotationInvocationHandler implements java.lang.reflect.InvocationHandler, Serializable {
    ...
    public Object invoke(Object proxy, java.lang.reflect.Method method, Object[] args) {
        ...
        if (result.getClass().isArray() && java.lang.reflect.Array.getLength(result) != 0)
    ...
    private Boolean equalsImpl(Object o) {
        ...
        if (!type.isInstance(o))
            return false;
        for (java.lang.reflect.Method memberMethod : getMemberMethods()) {
    ...
    private AnnotationInvocationHandler asOneOfUs(Object o) {
        if (java.lang.reflect.Proxy.isProxyClass(o.getClass())) {
            java.lang.reflect.InvocationHandler handler = java.lang.reflect.Proxy.getInvocationHandler(o);
            ...
            memberMethods = AccessController.doPrivileged(
                    new PrivilegedAction<java.lang.reflect.Method[]>() {
                        public java.lang.reflect.Method[] run() {
                            final java.lang.reflect.Method[] mm = type.getDeclaredMethods();
                            validateAnnotationMethods(mm);
                            java.lang.reflect.AccessibleObject.setAccessible(mm, true);
                            return mm;
                        }
                    });
        }
    ...
    private transient volatile java.lang.reflect.Method[] memberMethods = null;
     ...
     */
    private void validateAnnotationMethods(java.lang.reflect.Method[] memberMethods) {
        /*
        ...
        for (Method method : memberMethods) {
             ...
             */
            if (method.getModifiers() != (java.lang.reflect.Modifier.PUBLIC | java.lang.reflect.Modifier.ABSTRACT) ||
                    method.isDefault() ||
