...
public final class TypeAnnotationParser {
    ...
    public static AnnotatedType buildAnnotatedType(byte[] rawAnnotations,
                                                   ConstantPool cp,
                                                   java.lang.reflect.AnnotatedElement decl,
                                                   Class<?> container,
    ...
    public static AnnotatedType buildAnnotatedSuperclass(byte[] rawAnnotations,
                                                         ConstantPool cp,
                                                         Class<?> decl) {
        java.lang.reflect.Type supertype = decl.getGenericSuperclass();
        if (supertype == null)
    ...
    public static <D extends GenericDeclaration> Annotation[] parseTypeVariableAnnotations(D genericDecl,
        ...
        if (genericDecl instanceof Class) {
            ...
            if (genericDecl instanceof Executable) {
     ...
     */
    public static <D extends java.lang.reflect.GenericDeclaration> AnnotatedType[] parseAnnotatedBounds(java.lang.reflect.Type[] bounds,
                                                                                                        D decl,
                                                                                                        int typeVarIndex) {
    ...
    private static <D extends GenericDeclaration> List<TypeAnnotation> fetchBounds(D decl) {
        AnnotatedElement boundsDecl = null;
    ...
    private static TypeAnnotation[] parseTypeAnnotations(byte[] rawAnnotations,
                                                         ConstantPool cp,
                                                         java.lang.reflect.AnnotatedElement baseDecl,
                                                         Class<?> container) {
