...
public class AnnotationType {
     ...
     */
    private final Map<String, java.lang.reflect.Method> members;
    ...
    private AnnotationType(final Class<? extends Annotation> annotationClass) {
        ...
        java.lang.reflect.Method[] methods =
            AccessController.doPrivileged(new PrivilegedAction<java.lang.reflect.Method[]>() {
        ...
        members = new HashMap<String, java.lang.reflect.Method>(methods.length+1, 1.0f);
