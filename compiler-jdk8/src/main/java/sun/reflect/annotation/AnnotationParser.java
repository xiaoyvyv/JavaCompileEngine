...
public class AnnotationParser {
    ...
    private static Class<?> parseSig(String sig, Class<?> container) {
        ...
        java.lang.reflect.Type result = reify.getResult();
        return toClass(result);
    }
    static Class<?> toClass(java.lang.reflect.Type o) {
        if (o instanceof java.lang.reflect.GenericArrayType)
            return java.lang.reflect.Array.newInstance(toClass(((java.lang.reflect.GenericArrayType)o).getGenericComponentType()),
                                     0)
                .getClass();
        return (Class)o;
    }
    ...
    private static Object parseEnumArray(int length, Class<? extends Enum<?>> enumType,
                                         ...
                                         ConstantPool constPool,
                                         Class<?> container) {
        Object[] result = (Object[]) java.lang.reflect.Array.newInstance(enumType, length);
        boolean typeMismatch = false;
        int tag = 0;
