...
public class ConstantPool {
    ...
    public java.lang.reflect.Member getMethodAt(int index) {
        return getMethodAt0(constantPoolOop, index);
    }

    public java.lang.reflect.Member getMethodAtIfLoaded(int index) {
        return getMethodAtIfLoaded0(constantPoolOop, index);
    }

    public java.lang.reflect.Field getFieldAt(int index) {
        return getFieldAt0(constantPoolOop, index);
    }

    public java.lang.reflect.Field getFieldAtIfLoaded(int index) {
    ...
    private native java.lang.reflect.Member getMethodAt0(Object constantPoolOop, int index);

    private native java.lang.reflect.Member getMethodAtIfLoaded0(Object constantPoolOop, int index);

    private native java.lang.reflect.Field getFieldAt0(Object constantPoolOop, int index);
