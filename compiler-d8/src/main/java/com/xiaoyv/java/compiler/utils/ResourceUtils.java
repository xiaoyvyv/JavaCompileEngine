package com.xiaoyv.java.compiler.utils;
...
public final class ResourceUtils {
    ...
    public static int getIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "id", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "string", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "color", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "dimen", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "drawable", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "mipmap", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "layout", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "style", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "anim", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return GlobalUtils.getApp().getResources().getIdentifier(name, "menu", GlobalUtils.getApp().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = GlobalUtils.getApp().getAssets().list(assetsFilePath);
            if (assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        GlobalUtils.getApp().getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = GlobalUtils.getApp().getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(GlobalUtils.getApp().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                GlobalUtils.getApp().getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static String readRaw2String(final int resId, final String charsetName) {
        InputStream is = GlobalUtils.getApp().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) return null;
        if (isSpace(charsetName)) {
            return new String(bytes);
    ...
    public static List<String> readRaw2List(final int resId,
                                            final String charsetName) {
        return is2List(GlobalUtils.getApp().getResources().openRawResource(resId), charsetName);
    }
