    ...
    public static int main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    return com.xiaoyv.dx.command.dexer.Main.main(without(args, i));
                } else if (arg.equals("--dump")) {
                    com.xiaoyv.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    com.xiaoyv.dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    com.xiaoyv.dx.command.findusages.Main.main(without(args, i));
                    break;
